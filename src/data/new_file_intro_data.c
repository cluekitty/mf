...
const u8 sTilemap_598898[] = INCBIN_U8("data/new_file_intro/598898.tm.lz");

const u8 sTilemap_60B148[] = INCBIN_U8("data/new_file_intro/60B148.tm.lz");

const u8 sTilemap_60B670[] = INCBIN_U8("data/new_file_intro/60B670.tm.lz");

const u8 sGfx_60BCA4[] = INCBIN_U8("data/new_file_intro/60BCA4.gfx.lz");

const u8 sPal_612E48[] = INCBIN_U8("data/new_file_intro/612E48.pal");

static const u8 sBlob_612f48_613148[] = INCBIN_U8("data/Blob_612f48_613148.bin");

const u8 sGfx_613148[] = INCBIN_U8("data/new_file_intro/613148.gfx");
