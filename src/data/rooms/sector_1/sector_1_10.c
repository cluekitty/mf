...
const u8 sSector1_10_Bg2[14] = INCBIN_U8("data/rooms/sector_1/sector_1_10_bg2.gfx");

const u8 sSector1_10_Bg1[298] = INCBIN_U8("data/rooms/sector_1/sector_1_10_bg1.gfx");
