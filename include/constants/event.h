...
enum SubEvent {
    ...
    SUB_EVENT_FIRST_CONVERSATION_LEAVING_SHIP_STARTED,
    SUB_EVENT_ENTERED_ROOM_AFTER_FIRST_NAV_ROOM,
    ...
    SUB_EVENT_ENTERED_DARK_VERTICAL_SHAFT_AFTER_MISSILES,
    ...
    SUB_EVENT_SA_X_ELEVATOR_CUTSCENE_STARTED,
    ...
    SUB_EVENT_ENTERED_SRX1_NAV_ROOM,
    ...
    SUB_EVENT_ENTERED_NAV_ROOM_LEAVING_SRX1,
    SUB_EVENT_28,
    SUB_EVENT_LEAVING_SRX1_CONVERSATION_ENDED,
    SUB_EVENT_STARTED_ELEVATOR_TO_TRO1,
    SUB_EVENT_ELEVATOR_ENTERED_TRO1,
    SUB_EVENT_ENTERED_TRO1_NAV_ROOM,
    SUB_EVENT_ENTERING_TRO1_CONVERSATION_ENDED,
    SUB_EVENT_ENTERED_TRO1_FIRST_ROOM,
    SUB_EVENT_UNLOCKED_SECURITY_LEVEL_1,
    SUB_EVENT_DOWNLOADED_BOMBS,
    SUB_EVENT_ENTERED_ZAZABI_ROOM,
    SUB_EVENT_HI_JUMP_ABILITY_RECOVERED,
    SUB_EVENT_LEFT_ZAZABI_ROOM,
    SUB_EVENT_ENTERED_SA_X_TRO_1_ROOM,
    SUB_EVENT_LEFT_SA_X_TRO_1_ROOM,
    SUB_EVENT_LEAVING_TRO1_CONVERSATION_ENDED,
    SUB_EVENT_LEAVING_TRO1_ELEVATOR_MONOLOGUE_STARTED,
    SUB_EVENT_LEAVING_TRO1_ELEVATOR_MONOLOGUE_ENDED,
    SUB_EVENT_LEAVING_TRO1_ELEVATOR_ENDED,
    SUB_EVENT_ENTERED_AQA1_NAV_ROOM,
    SUB_EVENT_ENTERING_AQA1_CONVERSATION_ENDED,
    SUB_EVENT_ENTERED_FIRST_ROOM_IN_AQA1,
    ...
    SUB_EVENT_ENTERED_PYR1_SECURITY_ROOM,
    SUB_EVENT_UNLOCKED_SECURITY_LEVEL_2,
    SUB_EVENT_LEFT_PYR1_SECURITY_ROOM,
    SUB_EVENT_ENTERED_PYR1_DATA_ROOM,
    SUB_EVENT_DOWNLOADED_SUPER_MISSILES,
    SUB_EVENT_LEFT_PYR1_DATA_ROOM,
    SUB_EVENT_ENTERED_BOX_ROOM,
    SUB_EVENT_LEFT_BOX_ROOM,
    SUB_EVENT_LEAVING_PYR1_CONVERSATION_ENDED,
    SUB_EVENT_LEAVING_PYR1_FEDERATION_CONVERSATION_STARTED,
    SUB_EVENT_LEAVING_PYR1_FEDERATION_CONVERSATION_ENDED,
    SUB_EVENT_ENTERED_NOC1_NAV_ROOM,
    SUB_EVENT_ENTERING_NOC1_CONVERSATION_ENDED,
    SUB_EVENT_ENTERED_NOC1_FIRST_ROOM,
    SUB_EVENT_SA_X_NOC_ENTERED_ROOM,
    SUB_EVENT_SA_X_NOC_ENCOUNTER_ENDED,
    SUB_EVENT_ENTERED_GADORA_ROOM_BEFORE_MEGA_X,
    SUB_EVENT_VARIA_SUIT_RECOVERED,
    SUB_EVENT_LEFT_MEGA_X_ROOM,
    SUB_EVENT_ENTERING_ARC1_CONVERSATION_ENDED,
    SUB_EVENT_ENTERED_ARC1_FIRST_COLD_ROOM,
    SUB_EVENT_UNLOCKED_LEVEL_3_SECURITY,
    SUB_EVENT_DOWNLOADED_ICE_MISSILES,
    SUB_EVENT_EMERGENCY_IN_SECTOR_3_ALARM,
    SUB_EVENT_LEAVING_ARC1_CONVERSATION_STARTED,
    SUB_EVENT_LEAVING_ARC1_CONVERSATION_ENDED,
    SUB_EVENT_WIDE_BEAM_ABILITY_RECOVERED,
    SUB_EVENT_COOLING_UNIT_OPERATIONAL,
    SUB_EVENT_LEFT_MAIN_BOILER_CONTROL_ROOM,
    SUB_EVENT_LEAVING_PYR2_CONVERSATION_ENDED,
    SUB_EVENT_84,
    SUB_EVENT_85,
    SUB_EVENT_LEAVING_HABITATION_DECK_MONOLOGUE_STARTED,
    SUB_EVENT_87,
    SUB_EVENT_ENTERING_ARC2_CONVERSATION_ENDED,
    SUB_EVENT_ENTERED_ARC2_FIRST_COLD_ROOM,
    SUB_EVENT_DOWNLOADED_POWER_BOMBS,
    SUB_EVENT_ENTERED_SA_X_ARC_ROOM,
    SUB_EVENT_SA_X_ARC_ENTERED_ROOM,
    SUB_EVENT_LEFT_SA_X_ARC_ROOM,
    SUB_EVENT_LEAVING_ARC2_CONVERSATION_ENDED,
    SUB_EVENT_ELEVATOR_POWER_OUTAGE,
    SUB_EVENT_ENTERED_ELEVATOR_TUNNEL,
    SUB_EVENT_POWER_OUTAGE_SHIP_CONVERSATION_STARTED,
    SUB_EVENT_POWER_OUTAGE_SHIP_CONVERSATION_ENDED,
    SUB_EVENT_POWER_OUTAGE_LEAVING_SHIP_STARTED,
    SUB_EVENT_POWER_OUTAGE_LEAVING_SHIP_ENDED,
    SUB_EVENT_ENTERED_CENTRAL_REACTOR_CORE,
    SUB_EVENT_ENTERED_YAKUZA_ROOM,
    SUB_EVENT_SPACE_JUMP_ABILITY_RECOVERED,
    SUB_EVENT_LEAVING_YAKUZA_ROOM,
    SUB_EVENT_LEFT_YAKUZA_ROOM,
    SUB_EVENT_AUXILIARY_POWER_MESSAGE_STARTED,
    SUB_EVENT_AUXILIARY_POWER_MESSAGE_ENDED,
    SUB_EVENT_ENTERED_NAV_ROOM_AFTER_AUXILIARY_POWER,
    SUB_EVENT_AFTER_AUXILIARY_POWER_CONVERSATION_ENDED,
    SUB_EVENT_ENTERED_SA_X_TRO_2_1ST_ROOM,
    SUB_EVENT_111,
    SUB_EVENT_112,
    SUB_EVENT_APPROACHED_SA_X_TRO_2_1ST_ROOM_DOOR,
    SUB_EVENT_LEAVING_SA_X_TRO_2_2ND_ROOM,
    SUB_EVENT_LEFT_SA_X_TRO_2_2ND_ROOM,
    SUB_EVENT_ENTERED_NETTORI_ROOM,
    SUB_EVENT_PLASMA_BEAM_ABILITY_RECOVERED,
    SUB_EVENT_LEFT_NETTORI_ROOM,
    SUB_EVENT_ENTERING_ARC3_CONVERSATION_ENDED,
    SUB_EVENT_ENTERED_ARC3_FIRST_ROOM,
    SUB_EVENT_ENTERED_NIGHTMARE_ROOM,
    SUB_EVENT_GRAVITY_SUIT_RECOVERED,
    SUB_EVENT_LEFT_NIGHTMARE_ROOM,
    SUB_EVENT_ENTERED_LOWER_AQA,
    SUB_EVENT_UNLOCKED_SECURITY_LEVEL_4,
    SUB_EVENT_DOWNLOADED_DIFFUSION_MISSILES,
    SUB_EVENT_LEAVING_AQA2_CONVERSATION_ENDED,
    SUB_EVENT_LEAVING_AQA2_ELEVATOR,
    SUB_EVENT_LEAVING_AQA2_ELEVATOR_ENDED,
    SUB_EVENT_ENTERED_NOC2_NAV_ROOM,
    SUB_EVENT_ENTERING_NOC2_CONVERSATION_ENDED,
    SUB_EVENT_ENTERED_NOC2_FIRST_ROOM,
    SUB_EVENT_RESTRICTED_LAB_NO_ENTRY_ALARM,
    SUB_EVENT_BOX_2_RUMBLE,
    SUB_EVENT_ENTERED_BOX_2_ROOM,
    SUB_EVENT_WAVE_BEAM_ABILITY_RECOVERED,
    SUB_EVENT_LEFT_BOX_2_ROOM,
    SUB_EVENT_ENTERED_RESTRICTED_LAB,
    SUB_EVENT_SA_X_LAB_RUMBLE,
    SUB_EVENT_ENTERED_SA_X_LAB_ROOM,
    SUB_EVENT_ESCAPED_RESTRICTED_LAB,
    SUB_EVENT_RESTRICTED_LAB_CUTSCENE_ENDED,
    SUB_EVENT_RESTRICTED_LAB_CONVERSATION_ENDED,
    SUB_EVENT_RESTRICTED_LAB_ELEVATOR_MONOLOGUE_STARTED,
    SUB_EVENT_RESTRICTED_LAB_ELEVATOR_MONOLOGUE_ENDED,
    SUB_EVENT_RESTRICTED_LAB_ELEVATOR_ENDED,
    SUB_EVENT_ENTERED_ROOM_AFTER_RESTRICTED_LAB_ELEVATOR,
    SUB_EVENT_ENTERED_RIDLEY_ROOM,
    SUB_EVENT_SCREW_ATTACK_ABILITY_RECOVERED,
    SUB_EVENT_LEFT_RIDLEY_ROOM,
    SUB_EVENT_ENTERED_NAV_ROOM_AFTER_RIDLEY,
    SUB_EVENT_SELF_DESTRUCT_CONVERSATION_ENDED,
    SUB_EVENT_ENTERED_SA_X_BOSS_ROOM,
    SUB_EVENT_ORBIT_CHANGE_IMPLEMENTED,
    SUB_EVENT_ENTERED_OMEGA_METROID_ROOM,

    SUB_EVENT_END
};

enum SubEventTriggerType {
    SEVENT_TTYPE_NONE,
